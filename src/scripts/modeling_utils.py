...
if __name__ == '__main__':
    ...
    tb_path = '../runs/Mar06_21-26-12_bro-MS-7C91/events.out.tfevents.1678134372.bro-MS-7C91.24502.4'

    # where to save df
    save_path = '../runs/Mar06_21-26-12_bro-MS-7C91'
    ...
    graph_paths = [
        '../runs/Mar06_21-26-12_bro-MS-7C91/loss.png',
        '../runs/Mar06_21-26-12_bro-MS-7C91/rmse.png',
        '../runs/Mar06_21-26-12_bro-MS-7C91/mape.png',
        '../runs/Mar06_21-26-12_bro-MS-7C91/mae.png'
    ]
