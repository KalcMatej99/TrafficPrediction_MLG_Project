...
if __name__ == '__main__':
    ...
    run_name = "Mar20_18-01-37_aaa698c5eefa"
    tb_path = f'../runs/{run_name}/events.out.tfevents.1678134372.bro-MS-7C91.24502.4'
    ...
    graph_paths = [
        f'../runs/{run_name}/loss.png',
        f'../runs/{run_name}/rmse.png',
        f'../runs/{run_name}/mape.png',
        f'../runs/{run_name}/mae.png'
    ]
